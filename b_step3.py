def search_idx(k):
    idx = prev_ptr[end_idx]
    counter = 1

    target_idx = 1023
    prev_target_idx = 1023
    ...
    return prev_target_idx, target_idx
...
prev_target_idx, target_idx = search_idx(k)

next_ptr[prev_target_idx] = end_idx
prev_ptr[end_idx] = prev_target_idx
